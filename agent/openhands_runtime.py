...
class OpenHandsEvidenceRuntime:
    ...
    def __init__(self, config: RuntimeConfig, shared_dense_retriever: DenseRetriever | None = None) -> None:
        ...
        self.search_tool = APIWebSearchExecutor(
            ...
            searxng_url=str(self.web_cfg.get("searxng_url", "")),
        )
        ...
        outputs_dir = str(self.config.raw.get("paths", {}).get("outputs_dir", "outputs"))
        self.read_tool = RobustWebReadExecutor(
            ...
            enable_jina_reader=bool(self.agent_cfg.get("enable_jina_reader", True)),
            jina_max_chars=int(self.agent_cfg.get("jina_max_chars", 8000)),
            jina_use_readerlm_fallback=bool(self.agent_cfg.get("jina_use_readerlm_fallback", True)),
            jina_min_quality_score=float(self.agent_cfg.get("jina_min_quality_score", 0.55)),
            jina_min_clean_chars=int(self.agent_cfg.get("jina_min_clean_chars", 500)),
            enable_content_extraction=bool(self.agent_cfg.get("enable_trafilatura_extraction", True)),
            enable_browser_fallback=bool(self.agent_cfg.get("enable_browser_fallback", False)),
            browser_fallback_wait_ms=int(self.agent_cfg.get("browser_fallback_wait_ms", 2500)),
            enable_crawl4ai=bool(self.agent_cfg.get("enable_crawl4ai", True)),
            crawl4ai_timeout_seconds=float(self.agent_cfg.get("crawl4ai_timeout_seconds", web_read_timeout)),
            crawl4ai_max_chars=int(self.agent_cfg.get("crawl4ai_max_chars", 6000)),
            crawl4ai_word_count_threshold=int(self.agent_cfg.get("crawl4ai_word_count_threshold", 10)),
            crawl4ai_use_content_filter=bool(self.agent_cfg.get("crawl4ai_use_content_filter", True)),
            crawl4ai_content_filter_type=str(self.agent_cfg.get("crawl4ai_content_filter_type", "pruning")),
            crawl4ai_primary=bool(self.agent_cfg.get("crawl4ai_primary", False)),
            crawl4ai_markdown_mode=str(self.agent_cfg.get("crawl4ai_markdown_mode", "best")),
            crawl4ai_content_source=str(self.agent_cfg.get("crawl4ai_content_source", "best")),
            crawl4ai_enable_stealth=bool(self.agent_cfg.get("crawl4ai_enable_stealth", True)),
            crawl4ai_scan_full_page=bool(self.agent_cfg.get("crawl4ai_scan_full_page", True)),
            crawl4ai_delay_before_return_html=float(self.agent_cfg.get("crawl4ai_delay_before_return_html", 0.5)),
            crawl4ai_css_selector=str(self.agent_cfg.get("crawl4ai_css_selector", "")),
            crawl4ai_target_elements=list(self.agent_cfg.get("crawl4ai_target_elements") or []),
            crawl4ai_excluded_selector=str(self.agent_cfg.get("crawl4ai_excluded_selector", "")),
            crawl4ai_excluded_tags=list(self.agent_cfg.get("crawl4ai_excluded_tags") or []),
            enable_scrapling=bool(self.agent_cfg.get("enable_scrapling", False)),
            scrapling_timeout_seconds=float(self.agent_cfg.get("scrapling_timeout_seconds", web_read_timeout)),
            scrapling_max_chars=int(self.agent_cfg.get("scrapling_max_chars", 8000)),
            scrapling_mode=str(self.agent_cfg.get("scrapling_mode", "fetcher")),
            scrapling_content_source=str(self.agent_cfg.get("scrapling_content_source", "html")),
            scrapling_auto_match=bool(self.agent_cfg.get("scrapling_auto_match", True)),
            scrapling_network_idle=bool(self.agent_cfg.get("scrapling_network_idle", True)),
            scrapling_wait_ms=int(self.agent_cfg.get("scrapling_wait_ms", 0)),
            scrapling_wait_selector=str(self.agent_cfg.get("scrapling_wait_selector", "")),
            scrapling_disable_resources=bool(self.agent_cfg.get("scrapling_disable_resources", False)),
            scrapling_block_images=bool(self.agent_cfg.get("scrapling_block_images", True)),
            scrapling_google_search=bool(self.agent_cfg.get("scrapling_google_search", True)),
            scrapling_real_chrome=bool(self.agent_cfg.get("scrapling_real_chrome", False)),
            scrapling_css_selector=str(self.agent_cfg.get("scrapling_css_selector", "")),
            scrapling_target_elements=list(self.agent_cfg.get("scrapling_target_elements") or []),
            scrapling_excluded_selector=str(self.agent_cfg.get("scrapling_excluded_selector", "")),
            scrapling_excluded_tags=list(self.agent_cfg.get("scrapling_excluded_tags") or []),
            web_read_competitive_mode=bool(self.agent_cfg.get("web_read_competitive_mode", True)),
            web_read_competitive_timeout_seconds=float(self.agent_cfg.get("web_read_competitive_timeout_seconds", web_read_timeout)),
            web_read_min_quality_score=float(self.agent_cfg.get("web_read_min_quality_score", self.agent_cfg.get("jina_min_quality_score", 0.55))),
            web_read_min_clean_chars=int(self.agent_cfg.get("web_read_min_clean_chars", self.agent_cfg.get("jina_min_clean_chars", 500))),
            web_read_compare_mode=bool(self.agent_cfg.get("web_read_compare_mode", False)),
            backend_comparison_path=str(Path(outputs_dir) / "backend_comparison.jsonl") if self.agent_cfg.get("web_read_compare_mode", False) else None,
        )
